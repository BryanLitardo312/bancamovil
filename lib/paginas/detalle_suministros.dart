            ...
            child: IntrinsicHeight(
              child: Container(
                child: Column(
                  ...
                  children: [
                    const Text(
                      '¿No ha recibido los suministros?',
                      style:TextStyle(
                        fontSize: 16,
                        color: Colors.white,)
                      ),
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        Expanded(child: Text('${widget.solicitud['estacion']}', style:TextStyle(fontSize: 16,color:Colors.grey[800],fontWeight: FontWeight.bold),overflow: TextOverflow.clip)),
                      ],
                    ),
                  ),
