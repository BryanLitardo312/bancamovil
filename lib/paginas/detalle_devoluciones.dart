...
class DetalleDevolucionScreen extends StatefulWidget {
  ...
  const DetalleDevolucionScreen({Key? key, required this.solicitud}) : super(key: key);
  
  @override
  _DetalleDevolucionScreenState createState() => _DetalleDevolucionScreenState();
...
class _DetalleDevolucionScreenState extends State<DetalleDevolucionScreen> {
            ...
            TextButton(
              onPressed: () async {
                final newNote = BancoQuejas(
                  ...
                  bodega: item['BODEGA'],
                  estacion: item['EESS'],
                  proceso: 'Devoluciones bancarias',
              ...
              child: IntrinsicHeight(
                child: Container(
                  child: Column(
                    ...
                    children: [
                      const Text(
                        '¿No ha recibido el ejemplar de regreso?',
                        style:TextStyle(
                          fontSize: 16,
                          color: Colors.white,)
                        ),
          ...
          TextButton(
            ...
            TextButton(
              onPressed: () async {
                ...
                try {
                  //print('Datos a enviar: ${item['NOMBRE']}');
                  await devolucionesBanco.updateForm(newNote);
                  Navigator.pop(context);
                  valor.noteController.clear();
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Notificación enviada correctamente',style: TextStyle(fontSize: 18),),backgroundColor: Colors.green),
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<Datamodel>(
      ...
      body:Stack(
        children:[
          Positioned.fill(  // <-- Esto hace que ocupe todo el espacio disponible
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.location_history_rounded,color: Colors.grey[900],size:30),
                        const SizedBox(width: 15),
                        Expanded(child: Text('${widget.solicitud['EESS']}', style:TextStyle(fontSize: 16,color:Colors.grey[800],fontWeight: FontWeight.bold),overflow: TextOverflow.clip)),
                      ],
                    ),
                  ),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Icon(Icons.calendar_month_rounded,color: Colors.grey[900],size:30),
                                  const SizedBox(width: 15),
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Row(
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: [
                                  Icon(Icons.shopping_cart,color: Colors.grey[900],size:30),
                                  const SizedBox(width: 15),
                                  Expanded(child: Text(widget.solicitud['id'].toString(), style:TextStyle(fontSize: 16,color:Colors.grey[800]),overflow: TextOverflow.clip)),
                                ],
                              ),
                            ),
                          ],
                  ...
                  Container(
                    ...
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Icon(Icons.local_shipping_rounded,color: Colors.grey[900],size:30),
                        const SizedBox(width: 15),
                        Expanded(child: Text('${widget.solicitud['DETALLE']}', style:TextStyle(fontSize: 16,color:Colors.grey[800]),overflow: TextOverflow.clip)),
                      ],
                    ),
                  ),
                  const SizedBox(height: 25),
                  ...
                  Container(
                    ...
                    child: Row(
                      crossAxisAlignment: CrossAxisAlignment.center,
                      children: [
                        Icon(Icons.key,color: Colors.grey[900],size:30),
                        const SizedBox(width: 15),
                        Expanded(child: Text('${widget.solicitud['SECUENCIAL']}', style:TextStyle(fontSize: 16,color:Colors.grey[800]),overflow: TextOverflow.clip)),
                      ],
                    ),
                  ),
                  ...
                  Column(
                    ...
                    children: [
                      ...
                      children: [
                        ...
                        Text('Soportes', style: TextStyle(fontSize: 17, fontWeight: FontWeight.bold,color: Colors.black),),
                        const SizedBox(height: 5),
                        Container(
                          decoration: BoxDecoration(
                            color: Colors.black,
                          ...
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              Icon(Icons.person_pin_circle,color: Colors.grey[200],size:30),
                              const SizedBox(width: 15),
                              Expanded(child: Text('${widget.solicitud['COMENTARIOS']}', style:TextStyle(fontSize: 16,color:Colors.grey[200]),overflow: TextOverflow.clip)),
                            ],
                          ),
                        ),
                        const SizedBox(height: 10),
